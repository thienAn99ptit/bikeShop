...
function CardItem() {
  return (
    <div>
      <Link to={"#"} className="relative pt-[100%]">
        <span className="absolute top-[10px] left-[10px] flex justify-center items-center w-10 h-10 rounded-full bg-greenColor text-white text-[10px] font-semibold z-10">
          Sale
        </span>
        <div className="overflow-hidden mb-2">
          <img
            ...
            alt=""
            className="w-full h-auto object-cover hover:scale-125 transition-all"
          />
        </div>
        <p className="text-primaryTxt text-base">Cyclocress Bike1</p>
      </Link>
